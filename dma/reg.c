...
void defaults(int source)
{
	...
	modem_write_R(0x12C, (uint32_t)0);  //Loopback control [0 Loopback, 1 RF]
	modem_write_R(0x130, (uint32_t)1);  //DMA To DMA Direct Control  [0==Direct,1==Through Full Modem]
        sleep(1);
