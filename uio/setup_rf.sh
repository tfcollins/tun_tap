...
echo 900001000 > /sys/bus/iio/devices/iio:device1/out_altvoltage0_RX_LO_frequency
echo 1900000000 > /sys/bus/iio/devices/iio:device1/out_altvoltage1_TX_LO_frequency
